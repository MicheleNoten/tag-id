...
# p Sdg.create!(
#   name: "Biodiversity",
#   description: "This assessment focuses on conserving biodiversity in areas like farms or processing facilities. It evaluates the structure of a biodiversity management plan (BMP) to protect ecosystems, considering social and environmental impacts. The BMP, at higher levels, evaluates risks and aligns with the local landscape. Adaptive monitoring of biodiversity can focus on pressures causing loss, state of biodiversity, or monitoring-based actions, using the Pressure State, Response (PSR) framework. It emphasizes restoring habitat diversity through native species introduction, riparian area restoration, and habitat corridor conservation.",
# )
